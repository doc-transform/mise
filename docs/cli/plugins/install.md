...
- **别名**: `i`, `a`, `add`
- **源码**: [`src/cli/plugins/install.rs`](https://github.com/jdx/mise/blob/main/src/cli/plugins/install.rs)

安装插件

请注意，mise 在安装工具时可以自动安装插件，
例如：`mise install cmake@3.30` 会自动安装 cmake 插件
